...
const ColorModeToggler = () => {
  ...
  return (
    <button onClick={onClick} className="block px-5 py-2 mt-2 ml-auto bg-opacity-0 border-none appearance-none cursor-pointer tapHighlightColor-none focus:outline-none">
