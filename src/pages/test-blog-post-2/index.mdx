...
<input
  type="checkbox"
  class="w-4 h-4 text-indigo-500 border-gray-300 rounded focus:border-indigo-300 focus:ring-2 focus:ring-indigo-200 focus:ring-opacity-50"
/>
```
...
```html
<h1 class="font-bold text-9xl">What is this, an Apple website?</h1>
```
